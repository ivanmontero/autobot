...
parser.add_argument("--loading_sbert", action="store_true")
...
with SummaryWriter(log_dir=os.path.join(base_folder, args.save_path, "logs/")) as sw:
    ...
    if "train" in args.mode:
        ...
        if args.loading_sbert:
            barney = BarneySentenceTransformerAdapter.load(os.path.join(args.model_path, "0_BarneySentenceTransformerAdapter"))
        else:
